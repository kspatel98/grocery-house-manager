...
PLANS: dict[PlanName, PlanDefinition] = {
    PlanName.free: PlanDefinition(
        ...
        features=[
            ...
            "View and collaborate in houses created by paid owners",
            "Live updates and activity feed inside joined houses",
            "Upgrade to create your own house",
        ],
    ),
    PlanName.basic: PlanDefinition(
        ...
        features=[
            "Create up to 2 owned houses",
            "250 inventory products per house",
            "5 active shopping lists per house",
            "6 members per house",
            "65% new-user Basic offer for the first 2 billing months when eligible",
        ],
    ),
