      ...
      {!uploadResult && (
        <div className="receipt-v85-workbench">
          <div className="receipt-v85-upload-zone">
            ...
            <div className="receipt-scan-quality-v87" aria-label="Tips for a better receipt scan">
              <strong>For the best scan</strong>
              <span>☀️ Bright, even light</span><span>▭ Keep all four edges visible</span><span>↕ Flatten wrinkles</span><span>🔎 Make item text readable</span>
            </div>
          </div>
