...
function matchProduct(name:string, products:Product[]){
 ...
 for(const product of products){
   ...
   for(const variant of variants){
     ...
     const distinctiveSingles=new Set(['atta','maida','besan','ghee','sev']);
