...
export default function ExpensesPage() {
  ...
  return <main className="page shell wide expenses-page expenses-page-v82">
    ...
    <button className="expense-mobile-fab" onClick={() => { reset(); setOpen(true); }} aria-label={c.add}><span>＋</span><strong>{c.add}</strong></button>
